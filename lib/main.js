...
var wantToDonate = prefs.prefs['WantToDonate'];
var organisationWebsite = prefs.prefs['OrganisationWebsite'];
var amountToDonate = prefs.prefs['AmountToDonate'];
var maxTime = prefs.prefs['TimeUntilWarning'] * 60;
...
if(self.loadReason == 'install' || self.loadReason == 'enable' || self.loadReason == 'update' || self.loadReason == 'downgrade'){
  ...
  ss.storage.monthlyTime = {month: today.getMonth(), seconds: timeSpent};
}
